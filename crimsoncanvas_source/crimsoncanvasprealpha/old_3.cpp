	...
	for (;;)
	{
		...
		if (current_time - last_frame_time < 15)
		{
			...
			*/
			...
			if ((P1_LEFTY < -Input::stick_dead_zone && LAST_P1_LEFTY >= -Input::stick_dead_zone) || (P1_DPAD_UP == 1 && LAST_P1_DPAD_UP == 0) || (last_key_state[SDL_SCANCODE_W] == 0 && key_state[SDL_SCANCODE_W]))
			{
